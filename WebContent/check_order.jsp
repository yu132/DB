	...
	<div class="am-g">
		<div class="am-u-lg-10 am-u-md-12 am-u-sm-centered">
			 ...
			 <table class="am-table am-table-bordered">
			 	 ...
			 	 <caption><b> <font size="5" >客户订单</font></b></caption>
				...
				<c:forEach var="order" items="${OrderList}" varStatus="status">
		            <tr>
		                ...
		                <c:choose>  
						    ...
						    <c:when test="${order.orderState eq '等待支付'}">
						   
						    	 <td><a href="to_pay.action?orderId=${order.orderID}" class=""><font size="5">前往支付</font></a></td>
						   		
						    </c:when>  
						     
						    <c:otherwise> 
						   
						    	<td><a class="am-btn am-btn-primary" href="check_order_detail_customer.action?orderId=${order.orderID}" class="">查看详情</a></td>
