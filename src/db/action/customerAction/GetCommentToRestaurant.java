...
public class GetCommentToRestaurant extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		...
		Map<String,Object> result=customerService.getCommentToRestaurant(customer, restaurantId);
		
		String state=(String) result.get("Result");
		
		if(state.equals("Success")) {
			request.setAttribute("Comment", result.get("Comment"));
