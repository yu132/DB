...
public class GetCommentToCarrier extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		...
		Map<String,Object> result=customerService.getCommentToCarrier(customer, carrierId);
