...
public class DeleteCustomerReceivingInformation extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		...
		Map<String,Object> result=customerService.deleteCustomerReceivingInformation(customer, customerReceivingInformationID);
