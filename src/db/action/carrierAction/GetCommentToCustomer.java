...
public class GetCommentToCustomer extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		...
		Map<String,Object> result=carrierService.getCommentToCustomer(carrier, customerId);
