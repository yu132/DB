...
public class ChangeOrderStateToGetDishes extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		...
		Map<String,Object> result=carrierService.changeOrderStateToGetDishes(carrier, orderId);
