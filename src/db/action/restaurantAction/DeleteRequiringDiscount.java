...
public class DeleteRequiringDiscount extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		...
		Map<String,Object> result=restaurantService.deleteRequiringDiscount(restaurant, requiringDiscountID);
