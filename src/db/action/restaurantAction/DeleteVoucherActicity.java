...
public class DeleteVoucherActicity extends ActionSupport implements ServletRequestAware{
	...
	private Long voucherActicityID;
	...
	public String execute() throws Exception {
		...
		Map<String,Object> result=restaurantService.deleteVoucherActicity(restaurant, voucherActicityID);
