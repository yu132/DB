...
public class GetMenu extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		...
		Map<String,Object> result=restaurantService.getMenu(restaurant);
		
		String state=(String) result.get("Result");
		
		if(state.equals("Success")) {
			request.setAttribute("MenuList", result.get("MenuList"));
