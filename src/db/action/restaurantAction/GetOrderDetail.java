...
public class GetOrderDetail extends ActionSupport implements ServletRequestAware{
	...
	public String execute() throws Exception {
		...
		Map<String,Object> result=restaurantService.getOrderDetail(restaurant, orderId);
