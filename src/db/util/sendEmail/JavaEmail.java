...
public class JavaEmail {
	...
	public static boolean sendMail(String userName,String verificationCode,String receiveMailAccount) {
		try{
			JavaEmail.userName=userName;
			JavaEmail.verificationCode=verificationCode;
			JavaEmail.receiveMailAccount=receiveMailAccount;
			sendMail();
		}catch(Exception e) {
			return false;
		}
    ...
    private static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "DB DESIGN", "UTF-8"));
        ...
        message.setContent(userName+"用户"+"你好，你的验证码为：“"+verificationCode+"”请勿回复这封邮件", "text/html;charset=UTF-8");
